...
import { Search, Filter, Download, Heart, BarChart3, Eye, X, ChevronDown, Zap, Lightbulb, Ruler, Shield, Award, Loader2, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function FixturesPage() {
  ...
  useEffect(() => {
    ...
    fetchFixtures()
  }, [searchTerm, selectedCategory, selectedManufacturer, ppeRange, wattageRange, sortBy, page])
        ...
        <div className="bg-gray-900/80 backdrop-blur-xl border-b border-gray-800 sticky top-0 z-40">
            ...
            <div className="flex items-center gap-4">
              {compareList.length > 0 && (
                <Link href={`/fixtures/compare?ids=${compareList.join(',')}`}>
                  <button className="btn-gradient px-4 py-2 rounded-lg text-white text-sm">
          ...
          <div className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by manufacturer, model, or brand..."
                value={searchTerm}
            ...
            <button
              ...
              className="px-4 py-2 border border-gray-700 bg-gray-800 hover:bg-gray-700 rounded-lg text-gray-300 hover:text-white transition-colors flex items-center gap-2"
            >
