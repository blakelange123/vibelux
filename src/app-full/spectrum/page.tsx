...
const spectrumData = {
  ...
  fluorescent_4000k: [
    { wavelength: 380, intensity: 5 },
    { wavelength: 400, intensity: 12 },
    { wavelength: 435, intensity: 65 }, // Mercury peak
    { wavelength: 450, intensity: 45 },
    { wavelength: 480, intensity: 35 },
    { wavelength: 500, intensity: 40 },
    { wavelength: 546, intensity: 85 }, // Mercury peak
    { wavelength: 550, intensity: 80 },
    { wavelength: 580, intensity: 70 },
    { wavelength: 600, intensity: 65 },
    { wavelength: 611, intensity: 75 }, // Phosphor peak
    { wavelength: 650, intensity: 55 },
    { wavelength: 700, intensity: 25 },
    { wavelength: 750, intensity: 10 },
    { wavelength: 800, intensity: 5 }
  ],
  fluorescent_5000k: [
    { wavelength: 380, intensity: 8 },
    { wavelength: 400, intensity: 18 },
    { wavelength: 435, intensity: 70 }, // Mercury peak
    { wavelength: 450, intensity: 55 },
    { wavelength: 480, intensity: 45 },
    { wavelength: 500, intensity: 50 },
    { wavelength: 546, intensity: 90 }, // Mercury peak
    { wavelength: 550, intensity: 85 },
    { wavelength: 580, intensity: 75 },
    { wavelength: 600, intensity: 65 },
    { wavelength: 611, intensity: 70 }, // Phosphor peak
    { wavelength: 650, intensity: 50 },
    { wavelength: 700, intensity: 20 },
    { wavelength: 750, intensity: 8 },
    { wavelength: 800, intensity: 3 }
  ],
  fluorescent_6500k: [
    { wavelength: 380, intensity: 10 },
    { wavelength: 400, intensity: 25 },
    { wavelength: 435, intensity: 75 }, // Mercury peak
    { wavelength: 450, intensity: 65 },
    { wavelength: 480, intensity: 55 },
    { wavelength: 500, intensity: 60 },
    { wavelength: 546, intensity: 95 }, // Mercury peak
    { wavelength: 550, intensity: 90 },
    { wavelength: 580, intensity: 80 },
    { wavelength: 600, intensity: 70 },
    { wavelength: 611, intensity: 75 }, // Phosphor peak
    { wavelength: 650, intensity: 55 },
    { wavelength: 700, intensity: 25 },
    { wavelength: 750, intensity: 10 },
  ...
  incandescent: [
    { wavelength: 380, intensity: 5 },
    { wavelength: 400, intensity: 10 },
    { wavelength: 450, intensity: 20 },
    { wavelength: 500, intensity: 35 },
    { wavelength: 550, intensity: 55 },
    { wavelength: 600, intensity: 75 },
    { wavelength: 650, intensity: 85 },
    { wavelength: 700, intensity: 90 },
    { wavelength: 750, intensity: 95 },
    { wavelength: 800, intensity: 100 }
  ],
  halogen: [
    { wavelength: 380, intensity: 8 },
    { wavelength: 400, intensity: 15 },
    { wavelength: 450, intensity: 28 },
    { wavelength: 500, intensity: 45 },
    { wavelength: 550, intensity: 65 },
    { wavelength: 600, intensity: 80 },
    { wavelength: 650, intensity: 88 },
    { wavelength: 700, intensity: 92 },
    { wavelength: 750, intensity: 95 },
    { wavelength: 800, intensity: 98 }
  ],
  led_2700k: [
    { wavelength: 380, intensity: 5 },
    { wavelength: 400, intensity: 10 },
    { wavelength: 450, intensity: 45 }, // Blue LED peak
    { wavelength: 480, intensity: 30 },
    { wavelength: 500, intensity: 35 },
    { wavelength: 550, intensity: 65 },
    { wavelength: 600, intensity: 85 },
    { wavelength: 650, intensity: 90 },
    { wavelength: 700, intensity: 70 },
    { wavelength: 750, intensity: 40 },
    { wavelength: 800, intensity: 15 }
  ],
  led_3000k: [
    { wavelength: 380, intensity: 5 },
    { wavelength: 400, intensity: 12 },
    { wavelength: 450, intensity: 55 }, // Blue LED peak
    { wavelength: 480, intensity: 35 },
    { wavelength: 500, intensity: 40 },
    { wavelength: 550, intensity: 70 },
    { wavelength: 600, intensity: 80 },
    { wavelength: 650, intensity: 85 },
    { wavelength: 700, intensity: 60 },
    { wavelength: 750, intensity: 30 },
    { wavelength: 800, intensity: 10 }
  ],
  led_4000k: [
    { wavelength: 380, intensity: 8 },
    { wavelength: 400, intensity: 18 },
    { wavelength: 450, intensity: 70 }, // Blue LED peak
    { wavelength: 480, intensity: 45 },
    { wavelength: 500, intensity: 50 },
    { wavelength: 550, intensity: 75 },
    { wavelength: 600, intensity: 70 },
    { wavelength: 650, intensity: 65 },
    { wavelength: 700, intensity: 40 },
    { wavelength: 750, intensity: 20 },
    { wavelength: 800, intensity: 8 }
  ],
  led_5000k: [
    { wavelength: 380, intensity: 10 },
    { wavelength: 400, intensity: 22 },
    { wavelength: 450, intensity: 80 }, // Blue LED peak
    { wavelength: 480, intensity: 55 },
    { wavelength: 500, intensity: 60 },
    { wavelength: 550, intensity: 80 },
    { wavelength: 600, intensity: 65 },
...
export default function SpectrumAnalysisPage() {
  const [selectedSpectrum, setSelectedSpectrum] = useState<string>('led_full')
  ...
  // Helper function to format light source names
  const formatLightSourceName = (source: string): string => {
    const names: Record<string, string> = {
      'led_full': 'Full Spectrum LED',
      'hps': 'HPS',
      'cmh': 'CMH',
      'sunlight': 'Natural Sunlight',
      'led_2700k': 'LED 2700K (Warm)',
      'led_3000k': 'LED 3000K (Soft White)',
      'led_4000k': 'LED 4000K (Cool White)',
      'led_5000k': 'LED 5000K (Daylight)',
      'fluorescent_4000k': 'Fluorescent 4000K',
      'fluorescent_5000k': 'Fluorescent 5000K',
      'fluorescent_6500k': 'Fluorescent 6500K',
  ...
  const generateDLCSpectrum = (fixture: DLCFixture) => {
    ...
    if (totalFlux === 0) {
      // Generate a randomized but realistic LED spectrum when no flux data
      // Most LED fixtures have strong blue and red peaks
      const blueStrength = 70 + crypto.getRandomValues(new Uint32Array(1))[0] / 0xFFFFFFFF * 20; // 70-90
      const redStrength = 75 + crypto.getRandomValues(new Uint32Array(1))[0] / 0xFFFFFFFF * 20;  // 75-95
      const greenStrength = 20 + crypto.getRandomValues(new Uint32Array(1))[0] / 0xFFFFFFFF * 20; // 20-40
      
      return [
        { wavelength: 380, intensity: 5 },
        { wavelength: 400, intensity: 15 },
        { wavelength: 425, intensity: blueStrength * 0.7 },
        { wavelength: 450, intensity: blueStrength }, // Blue peak
        { wavelength: 475, intensity: blueStrength * 0.6 },
        { wavelength: 500, intensity: greenStrength * 0.8 },
        { wavelength: 525, intensity: greenStrength },
        { wavelength: 550, intensity: greenStrength * 0.9 }, // Green
        { wavelength: 575, intensity: greenStrength * 0.7 },
        { wavelength: 600, intensity: redStrength * 0.5 },
        { wavelength: 625, intensity: redStrength * 0.8 },
        { wavelength: 660, intensity: redStrength }, // Red peak
        { wavelength: 680, intensity: redStrength * 0.7 },
        { wavelength: 700, intensity: 25 },
        { wavelength: 730, intensity: 15 }, // Far red
        { wavelength: 750, intensity: 10 },
        { wavelength: 800, intensity: 5 }
      ]
    }
    ...
    // Create more detailed spectrum with smooth transitions
    return [
      { wavelength: 380, intensity: 5 },
      { wavelength: 400, intensity: blueIntensity * 0.3 },
      { wavelength: 425, intensity: blueIntensity * 0.7 },
      { wavelength: 450, intensity: blueIntensity }, // Blue peak
      { wavelength: 475, intensity: blueIntensity * 0.6 },
      { wavelength: 500, intensity: (blueIntensity * 0.3 + greenIntensity * 0.7) / 2 },
      { wavelength: 525, intensity: greenIntensity * 0.9 },
      { wavelength: 550, intensity: greenIntensity }, // Green peak
      { wavelength: 575, intensity: greenIntensity * 0.7 },
      { wavelength: 600, intensity: (greenIntensity * 0.3 + redIntensity * 0.7) / 2 },
      { wavelength: 625, intensity: redIntensity * 0.8 },
      { wavelength: 660, intensity: redIntensity }, // Red peak
      { wavelength: 680, intensity: redIntensity * 0.6 },
      { wavelength: 700, intensity: (redIntensity * 0.3 + farRedIntensity * 0.7) / 2 },
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <div className="bg-gray-800/50 backdrop-blur-xl rounded-xl p-6 border border-gray-700">
                ...
                <div className="space-y-2 max-h-[600px] overflow-y-auto">
                  ...
                  <div className="text-xs text-gray-400 uppercase tracking-wider mb-2 mt-2">Horticultural</div>
                  {[
                    ...
                    { value: 'dlc_fixture', label: 'DLC Fixture Database', icon: '🏭', badge: `${dlcFixtures.length}+ fixtures` }
                  ].map(source => (
                    <button
                      key={source.value}
                      onClick={() => setSelectedSpectrum(source.value)}
                      className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all relative ${
                        selectedSpectrum === source.value
                          ? 'bg-purple-600 text-white'
                          : 'bg-gray-800 text-gray-300 hover:bg-gray-700'
                      } ${source.value === 'dlc_fixture' ? 'border-2 border-purple-500/50' : ''}`}
                    >
                      <span className="text-2xl">{source.icon}</span>
                      <div className="flex-1 text-left">
                        <span className="text-sm font-medium">{source.label}</span>
                        {source.badge && (
                          <div className="text-xs mt-0.5 text-purple-300">{source.badge}</div>
                        )}
                      </div>
                      {source.value === 'dlc_fixture' && dlcFixtures.length > 0 && (
                  ...
                  {/* Natural Light */}
                  <div className="text-xs text-gray-400 uppercase tracking-wider mb-2 mt-4">Natural</div>
                  {[
                  ...
                  <div className="text-xs text-gray-400 uppercase tracking-wider mb-2 mt-4">LED by CCT</div>
                  {[
                    { value: 'led_2700k', label: 'LED 2700K (Warm)', icon: '🟠' },
                    { value: 'led_3000k', label: 'LED 3000K (Soft White)', icon: '🟡' },
                    { value: 'led_4000k', label: 'LED 4000K (Cool White)', icon: '⚡' },
                    { value: 'led_5000k', label: 'LED 5000K (Daylight)', icon: '❄️' }
                  ].map(source => (
                    <button
                      key={source.value}
                      onClick={() => setSelectedSpectrum(source.value)}
                  ...
                  {/* Fluorescent */}
                  <div className="text-xs text-gray-400 uppercase tracking-wider mb-2 mt-4">Fluorescent</div>
                  {[
                    { value: 'fluorescent_4000k', label: 'Fluorescent 4000K', icon: '🌫️' },
                    { value: 'fluorescent_5000k', label: 'Fluorescent 5000K', icon: '☁️' },
                    { value: 'fluorescent_6500k', label: 'Fluorescent 6500K', icon: '🌨️' }
                  ].map(source => (
                    <button
                      key={source.value}
                      onClick={() => setSelectedSpectrum(source.value)}
                  ...
                  {/* Traditional */}
                  <div className="text-xs text-gray-400 uppercase tracking-wider mb-2 mt-4">Traditional</div>
                  {[
                ...
                {selectedSpectrum === 'dlc_fixture' && (
                  <div className="mt-4 space-y-3 animate-fadeIn">
                    <div className="bg-purple-600/10 border-2 border-purple-500/50 rounded-lg p-3">
                      <div className="text-sm font-semibold text-purple-300 mb-2 flex items-center justify-between">
                        <span>Select a DLC Certified Fixture</span>
                        <span className="text-xs bg-purple-600/30 px-2 py-1 rounded-full">{dlcFixtures.length} available</span>
                      </div>
                      
                      {/* Show selected fixture info */}
                      {selectedDLCFixture ? (
                        <div className="mb-3 p-3 bg-purple-600/20 rounded-lg">
                          <div className="text-xs text-purple-300 mb-1">Currently Selected:</div>
                          <div className="text-sm font-medium text-white">{selectedDLCFixture.manufacturer}</div>
                          <div className="text-xs text-purple-200">{selectedDLCFixture.modelNumber}</div>
                          {selectedDLCFixture.reportedPPF > 0 && (
                            <div className="text-xs text-purple-300 mt-1">PPF: {selectedDLCFixture.reportedPPF.toFixed(0)}</div>
                          )}
                        </div>
                      ) : (
                        <div className="mb-3 p-3 bg-yellow-600/10 border border-yellow-500/30 rounded-lg">
                          <div className="text-xs text-yellow-300">⚠️ Please select a fixture from the list below</div>
                        </div>
                      )}
                    ...
                    {loadingFixtures ? (
                      ...
                      <div className="max-h-64 overflow-y-auto space-y-1 bg-gradient-to-br from-purple-900/20 to-blue-900/20 rounded-lg p-2 border-2 border-purple-500/30">
                        {dlcFixtures
                          .filter(fixture => 
                            !fixtureSearch || 
                          ...
                          .map(fixture => (
                            <button
                              key={fixture.id}
                              onClick={() => {
                                setSelectedDLCFixture(fixture);
                              }}
                              className={`w-full text-left px-3 py-3 rounded-lg text-sm transition-all border transform ${
                                selectedDLCFixture?.id === fixture.id
                                  ? 'bg-purple-600 text-white border-purple-500 shadow-lg shadow-purple-500/25 scale-[1.02]'
                                  : 'bg-gray-800/50 text-gray-300 hover:bg-gray-700 border-gray-700 hover:border-gray-600 hover:scale-[1.01]'
                              }`}
                            >
              ...
              {/* DLC Fixture Preview - Always visible */}
              {selectedSpectrum !== 'dlc_fixture' && dlcFixtures.length > 0 && (
                <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 backdrop-blur-xl rounded-xl p-4 border border-purple-500/30">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="text-sm font-medium text-purple-300">DLC Fixtures Available</h4>
                    <span className="text-xs bg-purple-600/30 px-2 py-1 rounded-full text-purple-200">{dlcFixtures.length}+</span>
                  </div>
                  <div className="space-y-1 mb-3">
                    {dlcFixtures.slice(0, 3).map((fixture, idx) => (
                      <div key={fixture.id} className="text-xs text-gray-400 truncate">
                        • {fixture.manufacturer} - {fixture.modelNumber}
                      </div>
                    ))}
                    {dlcFixtures.length > 3 && (
                      <div className="text-xs text-purple-300">
                        ... and {dlcFixtures.length - 3} more
                      </div>
                    )}
                  </div>
                  <button
                    onClick={() => setSelectedSpectrum('dlc_fixture')}
                  ...
                  >
                    <span>View All DLC Fixtures</span>
                ...
                {compareMode && (
                  <div className="mt-4 space-y-3">
                    ...
                    >
                      ...
                      <optgroup label="LED by CCT">
                        <option value="led_2700k">LED 2700K</option>
                        <option value="led_3000k">LED 3000K</option>
                        <option value="led_4000k">LED 4000K</option>
                        <option value="led_5000k">LED 5000K</option>
                      </optgroup>
                      <optgroup label="Fluorescent">
                        <option value="fluorescent_4000k">Fluorescent 4000K</option>
                        <option value="fluorescent_5000k">Fluorescent 5000K</option>
                        <option value="fluorescent_6500k">Fluorescent 6500K</option>
                      </optgroup>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-300">
                      {selectedSpectrum === 'dlc_fixture' && selectedDLCFixture
                        ...
                        : formatLightSourceName(selectedSpectrum)}
                    </span>
                  </div>
                  {showPAR && (
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-300">
                        {compareSpectrum === 'dlc_fixture' && compareDLCFixture
                          ...
                          : formatLightSourceName(compareSpectrum)}
                      </span>
                    </div>
                  )}
                </div>
